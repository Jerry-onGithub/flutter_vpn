...
class HomePage extends StatefulWidget {
  final ServerSelectionData data;
  HomePage({this.data});
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  ServerItemWidget(
                    flagAsset: widget.data.flagAsset != "" ? widget.data.flagAsset : 'assets/ghana.png',//'assets/ghana.png',
                    label: widget.data.label != "" ? widget.data.label : 'Ghana',//'Ghana',
                  ...
                  ElevatedButton.icon(
                    style: ElevatedButton.styleFrom(
                      ...
                      primary: Color.fromRGBO(37, 112, 252, 1),
                    ),
                    /*elevation: 0,
                    padding: EdgeInsets.symmetric(
                        vertical: 15,
